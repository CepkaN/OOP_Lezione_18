...
int main() {
	...
	rukzak.Remuovere();
	Location LOC;
	std::shared_ptr<Melo>cili222 = std::make_shared<Melo> ("Ciliegio", "grand", "cespuglio", 3000, "bianco", "Europe"," ");
	std::shared_ptr<Melo>cili333 = std::make_shared<Melo>("Ciliegio", "grand", "cespuglio", 3000, "bianco", "Europe"," ");
	Melo* melo = new Melo("Melo", "grand", "arbre", 300, "verde","Meli grandi", "Asia");
